...
Baixe o Python: Clique neste link para baixar.
...
Entre na pasta do projeto que você colocou na Área de Trabalho.

Procure um arquivo chamado INICIAR (ele pode ter um ícone de engrenagem ou uma tela preta).
