...
Este é o programinha que eu fiz para te ajudar a controlar as contas, o dinheiro que entra e o que sai. Ele foi feito para ser simples e rodar aí no seu computador.
...
Quando o arquivo baixar, **clique nele para abrir**.

🛑 PARE E OLHE: Antes de clicar em qualquer coisa, marque a caixinha lá embaixo que diz "Add python.exe to PATH" (Isso é muito importante!).

Agora clique no botão grandão "Install Now".
...
2.Procure um arquivo chamado INICIAR (ele pode ter um ícone de engrenagem ou uma tela preta).
...
Esqueceu de anotar? Não tem problema, pode abrir o programa a qualquer hora.

Deu erro? Se aparecer alguma mensagem vermelha ou o saldo não aparecer, me manda uma foto da tela (Print) no WhatsApp.
